...
- **Loyalty Information API** - Implemented the Loyalty Information API with `getLoyaltyInfo` endpoint to fetch customer loyalty data. Added `LoyaltyDetails` page and route for displaying customer loyalty information.
- **Environment Variable Externalization** - Externalized sensitive data into `.env` file. 
